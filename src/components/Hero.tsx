  ...
  return (
    ...
    >
      <div className="text-center max-w-4xl mx-auto">
        ...
        >
          <div
            className="w-2 h-2 bg-primary rounded-full mr-2 animate-pulse-glow"
            aria-hidden="true"
          />
        ...
        >
          Your <span className="text-primary text-glow">AI-Powered</span>
          <br />
          Career Hub
        </h1>
        ...
        >
          Master AI tools, accelerate your career, and gain practical skills for students and
        ...
        <div
          className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-center justify-center mb-12 sm:mb-16 animate-fade-in px-4 sm:px-0"
          style={{
            animationDelay: '0.2s',
