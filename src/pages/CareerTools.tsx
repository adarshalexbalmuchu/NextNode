...
import { ExternalLink, FileText, Users, Target, Briefcase, GraduationCap, Zap, TrendingUp } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              AI-powered tools and resources to accelerate your career growth, from resume building to interview preparation and beyond.
            </p>
          </div>
          ...
          <Tabs defaultValue="resume" className="mb-16">
            ...
            <TabsContent value="resume">
              <div className="mb-8">
                ...
                <p className="text-muted-foreground">Create compelling resumes and professional profiles that stand out</p>
              </div>
            ...
            <TabsContent value="interview">
              <div className="mb-8">
                ...
                <p className="text-muted-foreground">Master your interview skills with AI-powered practice and feedback</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <TabsContent value="skills">
              <div className="mb-8">
                ...
                <p className="text-muted-foreground">Assess, plan, and track your professional skill development journey</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <TabsContent value="networking">
              <div className="mb-8">
                ...
                <p className="text-muted-foreground">Build meaningful professional connections and expand your network</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card className="glass-panel p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                  Comprehensive guides written by career experts and AI specialists to help you navigate your professional journey.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center p-4 border border-border rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">From campus to career with AI assistance</p>
                ...
                <div className="text-center p-4 border border-border rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">Switch careers with confidence using AI</p>
                  <Button variant="outline" size="sm" asChild>
                ...
                <div className="text-center p-4 border border-border rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">Lead teams and projects with AI insights</p>
                  <Button variant="outline" size="sm" asChild>
          ...
          <section>
            <Card className="glass-panel text-center p-8 bg-gradient-to-r from-primary/10 to-secondary/10">
              ...
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                Get personalized career guidance and access to our premium tools with a free consultation.
              </p>
