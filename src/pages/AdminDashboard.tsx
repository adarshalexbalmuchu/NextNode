  ...
  if (stats.error) {
    return (
      <div className="min-h-screen w-full">
        ...
        <Header />
        <main className="container mx-auto px-4 sm:px-6 py-16 sm:py-20 text-center" role="main">
          <div className="text-red-500 w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-4 text-4xl sm:text-5xl" aria-hidden="true">⚠️</div>
    ...
    <div className="min-h-screen w-full">
      ...
      <main className="container mx-auto px-4 sm:px-6 py-16 sm:py-20" role="main">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="grid w-full grid-cols-2 sm:grid-cols-4 mb-6 sm:mb-8" role="tablist" aria-label="Dashboard sections">
            <TabsTrigger value="overview" className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm" role="tab">
              <BarChart3 className="w-3 h-3 sm:w-4 sm:h-4" aria-hidden="true" />
              <span className="hidden sm:inline">Overview</span>
              <span className="sm:hidden">Stats</span>
            </TabsTrigger>
            <TabsTrigger value="users" className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm" role="tab">
              <Users className="w-3 h-3 sm:w-4 sm:h-4" aria-hidden="true" />
              Users
            </TabsTrigger>
            <TabsTrigger value="posts" className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm" role="tab">
              <FileText className="w-3 h-3 sm:w-4 sm:h-4" aria-hidden="true" />
              Posts
            </TabsTrigger>
            <TabsTrigger value="analytics" className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm" role="tab">
              <BarChart3 className="w-3 h-3 sm:w-4 sm:h-4" aria-hidden="true" />
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    {recentActivities.length > 0 ? (
                      recentActivities.map((activity) => (
                        <div key={activity.id} className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4">
                ...
                <CardContent>
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge className="bg-green-500 text-white" aria-label="Database status: Healthy">Healthy</Badge>
                    </div>
                    <div className="flex items-center justify-between">
